...
func (in *GithubTokenSecret) DeepCopyInto(out *GithubTokenSecret) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GithubTokenSecret.
func (in *GithubTokenSecret) DeepCopy() *GithubTokenSecret {
	if in == nil {
		return nil
	}
	out := new(GithubTokenSecret)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GroupSyncSpec) DeepCopyInto(out *GroupSyncSpec) {
	*out = *in
	out.GithubTokenSecret = in.GithubTokenSecret
	if in.Teams != nil {
